...
## Purpose
Histórico de temporadas cerradas: listado accesible a admin y director, y aplicación del modo solo lectura en toda la app para datos de temporadas cerradas (creado al archivar el change add-historico).
