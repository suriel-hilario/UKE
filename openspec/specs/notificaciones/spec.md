...
## Purpose
Automatizar notificaciones por email para entrenadores: recordatorios diarios de asistencia/minutaje y un recordatorio semanal general, con contenido bilingüe (eu/es) e idempotencia vía `notificacion_enviada` (creado al archivar el change add-notificaciones).
